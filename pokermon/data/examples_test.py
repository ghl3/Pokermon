...
def test_fold_preflop() -> None:
    ...
    assert example_dict['features']['state__stack_sizes'] == [[199, 198, 200], [199, 198, 190],
                                                              [199, 198, 190]]
...
def test_full_hand() -> None:
    ...
    # Bet, Fold, Fold
    assert example_dict['features']['action__action_encoded'] == [[5], [3], [5], [4], [4], [5], [4],
                                                                  [3], [4], [5], [4], [4], [5], [4]]

    # Bet 10, fold, fold
    assert example_dict['features']['action__amount_added'] == [[10],
                                                                [0],
                                                                [24],
                                                                [23],
                                                                [15],
    ...
    # These are the states before the action (the blinds have already taken place)
    assert example_dict['features']['state__stack_sizes'] == [[299, 298, 300, 300],
 [299, 298, 290, 300],
 [299, 298, 290, 300],
 [275, 298, 290, 300],
 [275, 275, 290, 300],
 ...
 [175, 75, 275, 300]]
    ...
    # Hole Cards 0: Jc Ac As
    # Hole Cards 1: Jh Ad Kh
    assert example_dict['features']['state__hole_card_0_rank'] == [[5], [7], [14], [13], [5], [14], [13], [5], [14], [13], [14], [14], [13], [14]]
    assert example_dict['features']['state__hole_card_0_suit'] == [[2], [1], [4], [2], [2], [4], [2], [2], [4], [2], [4], [4], [2], [4]]
    assert example_dict['features']['state__hole_card_1_rank'] == [[5], [3], [13], [10], [5], [13], [10], [5], [13], [10], [13], [13], [10], [13]]
    assert example_dict['features']['state__hole_card_1_suit'] == [[4], [3], [1], [3], [4], [1], [3], [4], [1], [3], [1], [1], [3], [1]]

    # These are the indices of the actions
    assert example_dict['features']['state__action_index'] == [[3], [4], [5], [6], [7], [9], [10], [11], [13], [14], [15], [17], [18], [19]]
